...
#include <SdrTransmit/Top/SdrTransmitTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    SdrTransmit::TopologyState inputs;
    ...
    SdrTransmit::setupTopology(inputs);
    SdrTransmit::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SdrTransmit::teardownTopology(inputs);
