module SdrTransmit {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "SdrTransmitPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections Communications {
      # Framer to Modulator
      ComCcsds.framer.dataOut -> gmskMod.framerIn
      gmskMod.framerReturnOut -> ComCcsds.framer.dataReturnIn
      gmskMod.framerStatusOut -> ComCcsds.framer.comStatusIn

      # Modulator to IIO Driver
      gmskMod.driverOut -> comDriver.dataIn
      comDriver.ready -> gmskMod.drvConnected

      # Modulator Buffer Management
      gmskMod.bufferAllocate -> ComCcsds.commsBufferManager.bufferGetCallee
      gmskMod.bufferDeallocate -> ComCcsds.commsBufferManager.bufferSendIn
    }
