# SdrTransmit Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the SdrTransmit Application

In order to build the SdrTransmit application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:
...
The next step is to build the SdrTransmit application's code.
```
fprime-util build
```
...
To run the ground system without starting the SdrTransmit app:
```
...
```
cd SdrTransmit/build-artifacts/<platform>/bin/
./SdrTransmit -a 127.0.0.1 -p 50000
```
