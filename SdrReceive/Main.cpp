...
#include <SdrReceive/Top/SdrReceiveTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    SdrReceive::TopologyState inputs;
    ...
    SdrReceive::setupTopology(inputs);
    SdrReceive::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SdrReceive::teardownTopology(inputs);
